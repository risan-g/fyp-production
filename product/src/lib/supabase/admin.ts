...
if (!finalUrl || !finalKey) {
  throw new Error("Missing required Supabase admin configuration: DOTWV_SERVER_SUPABASE_URL (or DOTWV_PUBLIC_SUPABASE_URL) and SUPABASE_SERVICE_ROLE_KEY are required.");
}
